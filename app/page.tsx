...
export const metadata: Metadata = {
  ...
  description:
    "O Ohrly usa os sinais que sua operação já possui para acrescentar contexto depois do alerta e ajudar seu time a entender melhor a situação antes de decidir como agir.",
  openGraph: {
    title: "Ohrly — Seu health score encontrou o risco. E agora?",
    description:
      "Seu health score continua sendo o radar. O Ohrly começa depois do alerta, organizando a trajetória da relação para ajudar seu time a investigar e decidir como agir.",
    type: "website",
  },
};
