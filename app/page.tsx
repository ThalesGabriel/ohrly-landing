...
function HeroSection() {
  return (
    <div className="relative z-10 grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
      <div>
        <p className="mb-5 inline-flex rounded-full border border-indigo-300/20 bg-indigo-400/10 px-3 py-1 text-sm text-indigo-200">
          Observabilidade comportamental para fluxos digitais
        </p>

        <h1 className="max-w-2xl text-5xl font-semibold tracking-tight text-white sm:text-6xl lg:text-7xl">
          Seus sistemas podem estar degradando agora.
          <span className="block bg-gradient-to-r from-indigo-300 via-violet-300 to-indigo-500 bg-clip-text text-transparent">
            Mesmo com tudo “verde”.
          </span>
        </h1>

        <p className="mt-6 max-w-xl text-lg leading-8 text-slate-300">
          O Ohrly investiga quando fluxos digitais começam a perder consistência
          antes de qualquer incidente explícito.
        </p>

        <div className="mt-9 flex flex-col gap-4 sm:flex-row">
          <a
            href="#studies"
            className="inline-flex items-center justify-center rounded-xl bg-indigo-500 px-6 py-3 text-sm font-semibold text-white shadow-[0_0_40px_rgba(99,102,241,0.35)] transition hover:bg-indigo-400"
          >
            Ver estudo
          </a>
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center rounded-xl border border-indigo-300/40 px-6 py-3 text-sm font-semibold text-white transition hover:border-indigo-200 hover:bg-white/5"
          >
...
function StudiesSection() {
  return (
    <section id="studies" className="relative z-10 border-t border-white/10 pt-8">
      <h2 className="text-3xl font-semibold tracking-tight text-white">
        Estudos reais. Aprendizados concretos.
      </h2>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        {studies.map((study) => (
          ...
          >
            ...
            <p className="mt-4 min-h-[96px] text-sm leading-6 text-slate-400">
              {study.description}
            </p>

            <a
              href="#"
              className="mt-5 inline-flex text-sm font-medium text-indigo-300 transition hover:text-indigo-200"
            >
              Ver estudo →
            </a>
          </article>
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
        ...
        <a
          href="mailto:contato@ohrly.com.br?subject=Quero analisar um fluxo crítico"
          className="inline-flex w-full items-center justify-center rounded-xl bg-indigo-400 px-7 py-4 text-sm font-semibold text-white shadow-[0_0_40px_rgba(129,140,248,0.35)] transition hover:bg-indigo-300 sm:w-auto"
        >
