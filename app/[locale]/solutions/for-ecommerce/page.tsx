...
export default function EcommerceLandingPage() {
    ...
    const [simulatorTouched, setSimulatorTouched] = useState({
        templateOrScenario: false,
        parameter: false,
        completed: false,
    });
    ...
    function handleTemplateChange(value: FlowTemplateId) {
        setTemplateId(value);

        trackMetaEvent("EcommerceSimulatorTemplateSelected", {
            source: "ecommerce_landing",
            template: value,
            scenario: scenarioId,
            duration,
            recovery,
        ...
        setSimulatorTouched((current) =>
            maybeTrackSimulatorCompleted({
                ...current,
                templateOrScenario: true,
            }),
        );
    }

    function handleScenarioChange(value: ScenarioId) {
        setScenarioId(value);

        trackMetaEvent("EcommerceSimulatorScenarioSelected", {
            source: "ecommerce_landing",
            template: templateId,
            scenario: value,
            duration,
    ...
    function handleDurationChange(value: DurationOption) {
        ...
        trackMetaEvent("EcommerceSimulatorDurationChanged", {
            source: "ecommerce_landing",
            template: templateId,
            scenario: scenarioId,
            duration: value,
    ...
    function handleRecoveryChange(value: RecoveryOption) {
        ...
        trackMetaEvent("EcommerceSimulatorRecoveryChanged", {
            source: "ecommerce_landing",
            template: templateId,
            scenario: scenarioId,
            duration,
    ...
    function handlePropagationChange(value: PropagationOption) {
        ...
        trackMetaEvent("EcommerceSimulatorPropagationChanged", {
            source: "ecommerce_landing",
            template: templateId,
            scenario: scenarioId,
            duration,
    ...
    function maybeTrackSimulatorCompleted(nextState: {
        templateOrScenario: boolean;
        parameter: boolean;
        completed: boolean;
    }) {
        if (
            nextState.templateOrScenario &&
            nextState.parameter &&
            !nextState.completed
        ) {
            trackMetaEvent("EcommerceSimulatorCompleted", {
                source: "ecommerce_landing",
                template: templateId,
                scenario: scenarioId,
                duration,
            ...
            <div>
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                    <Link
                        href="#simulador"
                        onClick={() =>
                            trackMetaEvent("EcommerceHeroSimulatorClick", {
                                source: "ecommerce_landing",
                                section: "hero",
        ...
        <section className="mt-10 rounded-3xl border border-cyan-300/25 bg-cyan-300/10 p-6 shadow-xl shadow-cyan-500/10 backdrop-blur lg:flex lg:items-center lg:justify-between lg:gap-8 lg:p-8">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row lg:mt-0">
                <Link
                    href="/request"
                    onClick={() =>
                        trackMetaEvent("EcommerceRequestClick", {
                            source: "ecommerce_landing",
                            section: "final_cta",
                            destination: "/request",
                        })
