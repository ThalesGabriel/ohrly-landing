            ...
            <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10">
                ...
                <nav className="hidden items-center gap-8 text-sm font-medium text-slate-600 dark:text-slate-300 md:flex">
                    ...
                    <a
                        href="#exemplo"
                        onClick={() =>
                            trackMetaEvent("BotsHeroExampleClick", {
                                source: "bots_landing",
                                section: "hero",
                                destination: "#exemplo",
                            })
            ...
            <div className="mt-5 rounded-3xl border border-cyan-200 bg-white/85 p-5 shadow-xl shadow-slate-200/50 backdrop-blur dark:border-cyan-400/30 dark:bg-slate-950/70 dark:shadow-cyan-950/20 lg:p-6">
                <div className="grid gap-6 lg:grid-cols-[1.4fr_0.55fr_0.8fr_1.3fr_auto] lg:items-center">
                    ...
                    <Link
                        href="/simulations"
                        onClick={() =>
                            trackMetaEvent("BotsExampleSimulationClick", {
                                source: "bots_landing",
                                section: "example_reading",
                                destination: "/simulations",
                                example: "bot_handoff_fallback_resolution",
                                rpi: 61,
                                state: "attention",
                            })
                        }
...
function StartWithoutIntegration() {
    ...
    const sectionRef = useTrackSectionView("BotsFieldsSectionViewed", {
        source: "bots_landing",
        section: "start_without_integration",
        fieldsCount: suggestedFields.length,
    });
        ...
        <section className="rounded-3xl border border-cyan-200 bg-cyan-50/70 p-6 shadow-xl shadow-cyan-500/10 backdrop-blur dark:border-cyan-400/25 dark:bg-cyan-400/10 lg:flex lg:items-center lg:justify-between lg:gap-8">
            ...
            <div className="mt-6 lg:mt-0">
                <Link
                    href="/request"
                    onClick={() =>
                        trackMetaEvent("BotsRequestClick", {
                            source: "bots_landing",
                            section: "final_cta",
                            destination: "/request",
