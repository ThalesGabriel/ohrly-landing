        ...
        <section className="mx-auto max-w-7xl px-6 pb-10 pt-10 lg:px-8 lg:pt-16">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              ...
              <h1 className="max-w-3xl text-4xl font-black tracking-[-0.045em] text-[#06183d] sm:text-5xl lg:text-6xl">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="rounded-[1.5rem] bg-[#004653] p-6 text-white">
                <p className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-sm font-black">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="overflow-hidden rounded-2xl border border-slate-200">
                <div className="grid grid-cols-3 bg-slate-50 text-xs font-black uppercase tracking-[0.14em] text-slate-500">
                ...
                {commissionExamples.map((example) => (
                  ...
                  >
                    <div className="p-4 font-black text-[#06183d]">
                      {example.offer}
                    </div>
                    <div className="p-4 text-right font-bold text-slate-600">
                      {example.value}
                    </div>
                    <div className="p-4 text-right font-black text-teal-800">
                      {example.commission}
                    </div>
                  </div>
                ))}
          ...
          <div className="rounded-[2rem] border border-cyan-100 bg-cyan-50 p-6 sm:p-8">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
              <div>
                ...
                <Link
                  href="#candidatura"
                  className="mt-6 inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#004653] px-6 text-sm font-black text-white shadow-lg shadow-teal-900/10 transition hover:bg-[#003844]"
                >
                  Propor workshop
                  <ArrowRight className="h-4 w-4" />
                </Link>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                {workshopFormats.map((format) => (
                  <div
                    key={format}
                    className="flex items-center gap-3 rounded-2xl border border-cyan-100 bg-white p-4 text-sm font-black text-[#06183d] shadow-sm"
                  >
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <div className="mt-6 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                <p className="font-black text-[#06183d]">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-12 pt-8 lg:px-8">
          <div className="relative overflow-hidden rounded-[2rem] bg-[#004653] p-8 text-white shadow-xl shadow-teal-950/10 md:p-12">
            ...
            <div className="relative z-10 grid grid-cols-1 items-center gap-8 lg:grid-cols-[1fr_auto]">
              ...
              <Link
                href="#candidatura"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-white px-6 text-sm font-black text-[#004653] shadow-lg transition hover:bg-slate-100"
              >
                Quero ser parceiro
                <ArrowRight className="h-4 w-4" />
              </Link>
...
function PartnerTypeCard({ partnerType }: { partnerType: PartnerType }) {
  ...
  return (
    <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <h3 className="mt-5 text-xl font-black text-[#06183d]">
        {partnerType.title}
      </h3>
...
function HowItWorksCard({
  ...
  return (
    <div className="relative rounded-[2rem] border border-slate-200 bg-slate-50 p-5">
      <span className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-sm font-black text-teal-900 shadow-sm">
        {index}
      </span>
      ...
      <h3 className="mt-5 font-black leading-6 text-[#06183d]">{step.title}</h3>
...
function PartnerApplicationForm() {
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="text-2xl font-black tracking-tight text-[#06183d]">
      ...
      <fieldset className="mt-8">
        <legend className="mb-4 text-sm font-black text-[#06183d]">
          Tipo de parceiro
        </legend>
      ...
      <label className="mt-8 block">
        <span className="mb-2 block text-sm font-black text-[#06183d]">
          Mensagem
        </span>
...
function FaqItem({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      >
        <span className="font-black text-[#06183d]">{faq.question}</span>
