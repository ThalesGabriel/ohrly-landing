            ...
            <section className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-6 py-10 lg:grid-cols-[0.75fr_1.35fr] lg:px-8 lg:py-16">
                <aside className="lg:sticky lg:top-24 lg:h-fit">
                    ...
                    <div className="mt-6 rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
                        <h2 className="text-xl font-black tracking-tight text-[#06183d]">
...
function InfoCard({
    ...
    return (
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 flex items-center gap-2">
            ...
            <p className="text-sm font-black text-[#06183d]">{title}</p>
        </div>
    );
}
...
function ScoreDimension({ title, text }: { title: string; text: string }) {
    return (
        <div className="flex gap-3">
            ...
            <div>
                <h3 className="font-black text-[#06183d]">{title}</h3>
        ...
        <div className="border-b border-slate-200 pb-8">
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                <div>
                    ...
                    <h2 className="mt-1 text-2xl font-black tracking-tight text-[#06183d]">
                ...
                {wizardSteps.map((step, index) => {
                    ...
                    return (
                        <div
                            key={step.title}
                            className={[
                                "flex min-w-fit items-center gap-2 rounded-full border px-3 py-2 text-xs font-black",
                                isActive
    ...
    return (
        <section>
            <div className="mb-6 flex gap-4">
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-teal-50 text-sm font-black text-teal-900">
                    {number}
                </span>

                <div>
                    <h3 className="text-xl font-black text-[#06183d]">{title}</h3>
    ...
    return (
        <div className="mt-10 flex flex-col-reverse gap-3 border-t border-slate-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
            <button
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 text-sm font-black text-slate-700 transition hover:border-teal-700 disabled:cursor-not-allowed disabled:opacity-40"
            >
            ...
            {isLastQuestionStep ? (
                <button
                    ...
                    onClick={onFinish}
                    disabled={!isValid}
                    className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#004653] px-6 text-sm font-black text-white shadow-lg shadow-teal-900/10 transition hover:bg-[#003844] disabled:cursor-not-allowed disabled:opacity-40"
                >
                    Gerar diagnóstico
...
function SelectableCard({
    ...
    return (
        ...
        >
            ...
            <span className="flex-1 text-sm font-black leading-5 text-[#06183d]">
                {option.label}
            </span>
    ...
    return (
        ...
        >
            <div className="rounded-3xl bg-white p-6 shadow-sm">
                ...
                <h2 className="mt-5 text-3xl font-black tracking-tight text-[#06183d]">
                    {result.tone.title}
                </h2>
            ...
            <div className="mt-5 grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div className="space-y-4">
                    <div className="rounded-3xl bg-white p-6 shadow-sm">
                        <h3 className="font-black text-[#06183d]">
...
function MiniScore({
    ...
    return (
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-2 text-xl font-black text-[#06183d]">{percent}%</p>
