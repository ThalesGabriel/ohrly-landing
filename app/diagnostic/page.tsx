...
export default function OhrlyDiagnosticPage() {
  ...
  return (
    <main className="min-h-screen pt-20 overflow-hidden bg-[#040917] text-white">
      <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(124,58,237,0.24),transparent_28%),radial-gradient(circle_at_82%_20%,rgba(14,165,233,0.14),transparent_28%),linear-gradient(rgba(255,255,255,0.035)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.035)_1px,transparent_1px)] bg-[size:auto,auto,88px_88px,88px_88px]" />

      <Header/>

      <section className="relative z-10 mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-12">
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          ...
          Observabilidade comportamental para fluxos digitais
            ...
            <h1 className="mt-5 max-w-4xl text-4xl font-bold leading-tight tracking-tight text-white md:text-6xl">
              Descubra se um fluxo da sua operação está entrando em degradação silenciosa.
            </h1>
            <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-300">
              Responda algumas perguntas rápidas para estruturar um caso real. Ao final, você recebe uma leitura inicial e um resumo pronto para enviar para a Ohrly.
            </p>
            <div className="mt-7 flex items-center gap-3 text-sm text-slate-300">
              <span className="flex h-8 w-8 items-center justify-center rounded-full border border-violet-400/30 text-violet-300">⌁</span>
              <span>Não precisa integrar nada agora. Um export simples já pode ser suficiente para a primeira leitura.</span>
            </div>
          </div>
      ...
      <section id="diagnostico" className="relative z-10 mx-auto grid max-w-7xl gap-5 px-6 pb-8 lg:grid-cols-[1.25fr_0.75fr] lg:px-8">
