...
function Eyebrow({
  ...
  return (
    ...
    <div
      ...
      className={`inline-flex items-center gap-2 text-[11px] font-black uppercase tracking-[.13em] ${light ? "text-[#b9cbff]" : "text-[#1457ff]"
    ...
    >
      ...
      <span
        ...
        className={`size-2 rounded-full ${light
    ...
    <div className="grid grid-cols-10 gap-1.5">
      ...
      {Array.from({ length: total }).map((_, index) => (
        ...
        <span
          ...
          className={`h-3.5 rounded-[5px] ${tone === "risk"
    ...
    <div className="grid grid-cols-[84px_1fr_auto] items-center gap-3 text-xs sm:grid-cols-[96px_1fr_auto]">
      ...
      <div className="h-2 overflow-hidden rounded-full bg-[#edf1f6]">
        ...
        <span
          ...
          className={`block h-full rounded-full ${changed ? "bg-[#f43b35]" : "bg-[#1457ff]"
      ...
      <strong
        ...
        className={`text-[11px] ${changed ? "text-[#c8322d]" : "text-[#39455c]"
                    ...
                    {[
                      ...
                      <div key={item.title} className="contents">
                        ...
                        <div
                          ...
                          className={`min-h-[180px] rounded-[22px] border p-5 ${item.active
