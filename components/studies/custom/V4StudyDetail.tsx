      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 py-8 lg:grid-cols-[0.75fr_1.25fr] lg:px-8">
        <aside className="lg:sticky lg:top-24 lg:h-fit">
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <h2 className="mt-3 text-2xl font-black tracking-tight text-[#06183d]">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-[2rem] border border-teal-100 bg-teal-50 p-6 sm:p-8">
            <p className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-sm font-black text-teal-900">
...
function InsightCard({
  ...
  return (
    <div className="border-t border-slate-200 p-6 lg:border-l lg:border-t-0">
      ...
      <h3 className="mt-5 font-black text-[#06183d]">{title}</h3>
  ...
  return (
    <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
      <div className="flex gap-5">
        <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-slate-100 text-sm font-black text-slate-500">
          {eyebrow}
        </span>
